...
//if rodzajzabicia=5 {instance_destroy(); lolox=instance_create(x,y+16,o_rybekadie);lolox.sprite_index=s_fish3; lolo=instance_create(x,y,o_punkciornik); lolo.image_index=0;if global.sample=1 {fofo=sound_play(snd_kick);sound_volume(snd_kick,global.glosnosc)}}
...
if rodzajzabicia=2 {instance_destroy(); lolox=instance_create(x,y+16,o_rybekadie);lolox.sprite_index=s_fish4}
//if rodzajzabicia=1 {instance_destroy(); lolox=instance_create(x,y+16,o_rybekadie);lolox.sprite_index=s_fish3; instance_create(x,y,o_punkciornik)}
