...
if rodzajzabicia=1 {instance_destroy(); redduj=instance_create(x,y-1,o_troopashell2);redduj.sprite_index=s_troopablueshell;instance_create(x,y,o_punkciornik); redduj.czerwona=czerwona}
if rodzajzabicia=7 {instance_destroy(); redduj=instance_create(x,y-1,o_troopashell2);redduj.sprite_index=s_troopablueshell;redduj.is_flipped=1;redduj.grawitacja=-11;instance_create(x,y,o_punkciornik); redduj.czerwona=czerwona;redduj.tail_kicked=1;redduj.kierunek=kierunek}
