...
if coto<17
draw_sprite(s_markersbank,coto,x,y) else
switch(coto) {
case 17:
...
case 23: {
    ...
    if scrollspeed<1{scrollspeed=1}*/
        ...
        if mouse_x>x && mouse_x<x+32 && mouse_y>y && mouse_y<y+32 && keyboard_check(global.key_submenu) && global.picking=false {
            ...
            if is_orange=0 {menustr='Set the scroll speed (unit: 0.01 pixel). Max=6000|Switch to orange scroll'} else {menustr='Set the scroll speed (unit: 0.01 pixel). Max=6000|Switch to white scroll'}
