...
applies_to=self
*/
shrock1=instance_create(-1000,-1000,o_rotoanim)
/*kat=0
promien=120
szybkosc=1*/
rodzaj=0
...
if global.pauza=0 && global.level_complete=0 {
    ...
    shrock1.x=x+16+use_radius*sin(degtorad(kat+90+spin_angle))
    shrock1.y=y+16+use_radius*cos(degtorad(kat+90+spin_angle))
    spin_angle+=hspd
}
