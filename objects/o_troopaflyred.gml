...
if rodzajzabicia=7 {instance_destroy(); redduj=instance_create(x,y-1,o_troopashell2);redduj.sprite_index=s_trooparedshell;redduj.is_flipped=1;redduj.grawitacja=-11;redduj.czerwona=1;redduj.tail_kicked=1;redduj.kierunek=kierunek; instance_create(x,y,o_punkciornik)}
