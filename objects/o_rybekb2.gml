...
if is_swimming=1 && y<=global.poziomwody{
  fofo=instance_create(x,y,o_rybekb3);
  fofo.xspeed=4-irandom(2)+1.25
...
if aktywowany=1{
// chodzenie
if kierunek=-1 {x-=2; image_xscale=-1}
if kierunek=1 {x+=2; image_xscale=1}
...
if rodzajzabicia=3 || rodzajzabicia=4 || rodzajzabicia=5 {instance_destroy(); lolox=instance_create(x,y+16,o_rybekadie); lolo=instance_create(x,y,o_punkciornik); lolo.image_index=0;lolox.sprite_index=s_fish2;if global.sample=1 {fofo=sound_play(snd_kick);sound_volume(snd_kick,global.glosnosc)}}
