...
applies_to=self
*/
if dir=-1 {draw_sprite_ext(s_bonusdead,animacja2,x+bounce_phase*1.6,y+fall_anim2*1.6,1-bounce_phase/20,1-fall_anim2/20,0,c_white,1)}
if dir=1 {draw_sprite_ext(s_bonusdead,animacja2,x,y+fall_anim2*1.6,1-bounce_phase/20,1-fall_anim2/20,0,c_white,1)}
