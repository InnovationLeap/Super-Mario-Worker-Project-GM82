...
applies_to=self
*/
if kierunek=-1 {draw_sprite_ext(s_bonusdead,animacja2,x+sekwodbicia*1.6,y+spadaczanim2*1.6,1-sekwodbicia/20,1-spadaczanim2/20,0,c_white,1)}
if kierunek=1 {draw_sprite_ext(s_bonusdead,animacja2,x,y+spadaczanim2*1.6,1-sekwodbicia/20,1-spadaczanim2/20,0,c_white,1)}
