...
if global.pauza=0 && global.etappokonany=0 {
    ...
    if rodzajzabicia=7 {instance_destroy(); redduj=instance_create(x,y-1,o_troopashell2);redduj.sprite_index=s_troopashellgold;redduj.is_flipped=1;redduj.grawitacja=-11;instance_create(x,y,o_punkciornik); redduj.czerwona=czerwona;redduj.tail_kicked=1;redduj.kierunek=kierunek}
