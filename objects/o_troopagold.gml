...
if global.pauza=0 && global.level_complete=0 {
    ...
    if kill_type=1 {instance_destroy(); shell_inst=instance_create(x,y-1,o_troopashell2);shell_inst.sprite_index=s_troopashellgold;instance_create(x,y,o_scorepop); shell_inst.shell_kind=shell_kind}
    if kill_type=7 {instance_destroy(); shell_inst=instance_create(x,y-1,o_troopashell2);shell_inst.sprite_index=s_troopashellgold;shell_inst.is_flipped=1;shell_inst.grav=-11;instance_create(x,y,o_scorepop); shell_inst.shell_kind=shell_kind;shell_inst.tail_kicked=1;shell_inst.dir=dir}
