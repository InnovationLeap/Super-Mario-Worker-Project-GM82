...
### Editor
- Refactored parts of the Edit interface.
### Bug Fixes
...
- Fixed the issue where the Edit selection could not directly select pipe exits.
...
### Miscellaneous
- The level version number generated by the game was bumped from 1713 to 1714.
