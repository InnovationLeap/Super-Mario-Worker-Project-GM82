GZ_DeCompressFile(global.toload,filename_change_ext(global.toload,'.mflx'))
global.toload=filename_change_ext(global.toload,'.mflx')
...
while !file_text_eof(global.toload){
 ...
 if string_char_at(aa,0)='0'{
  ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),v_ens[real(string_copy(aa,2,2))])
...
if string_char_at(aa,0)='2'{
  ...
  if ai=17{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4))+32,transA(string_copy(aa,8,4))+32,o_exitar)}
  if ai=18{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),obj_wall)}
  if ai=19 && ah=0{ah=1;ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_marker)}
  if ai=20 {ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_checkpoint);skript=string_insert('('+string(ae)+').checknumber='+string(checka)+';',skript,string_length(skript)+1);global.check[checka,0]=0;global.check[checka,1]=0;checka+=1}
  if ai<17{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_windas);skript=string_insert('('+string(ae)+').type='+string(ai)+';',skript,string_length(skript)+1)}
  if ai=21{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_windas);skript=string_insert('('+string(ae)+').type='+string(17)+';',skript,string_length(skript)+1)}
  if ai=22{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),obj_waall)}
  if ai=23{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_scroll);skript=string_insert('('+string(ae)+').scrollspeed='+string(transA(string_copy(aa,12,3)))+';',skript,string_length(skript)+1)
  ds_list_add(global.autoscrolls,ae)}//恶劣强滚
  if ai=24{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_onlyU)}
  if ai=25{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_windas);skript=string_insert('('+string(ae)+').type='+string_copy(aa,12,3)+'+6*'+string_copy(aa,15,3)+';',skript,string_length(skript)+1)}
  if ai=26{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_messageblock);skript=string_insert('('+string(ae)+').textMessage='+chr(34)+Message_Trans(string_copy(aa,12,string_length(aa)-11))+chr(34),skript,string_length(skript)+1)}
  if ai=27{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_switch);skript=string_insert('('+string(ae)+').color='+string_copy(aa,12,1)+';',skript,string_length(skript)+1)}
  if ai=28{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_yinyang);skript=string_insert('('+string(ae)+').color='+string_copy(aa,12,1)+';'+'('+string(ae)+').yin=1;',skript,string_length(skript)+1)}
  if ai=29{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_yinyang);skript=string_insert('('+string(ae)+').color='+string_copy(aa,12,1)+';'+'('+string(ae)+').yin=0;',skript,string_length(skript)+1)}
  if ai=30{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_ice)}
  if ai=31{switch(string_copy(aa,12,1)){
  case '0': ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),obj_halfwall);break;
  case '1': ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),obj_halfground);break;
  case '2': ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),obj_static);break;
  }
  }
  if ai=32{switch(string_copy(aa,17,1)){
  case '0': ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_waterchanger);skript=string_insert('('+string(ae)+').target='+string(transA(string_copy(aa,12,4)))+';('+string(ae)+').velocity='+string_copy(aa,16,1)+';('+string(ae)+').reuse=1;',skript,string_length(skript)+1)break;
  case '1': ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_waterchanger);skript=string_insert('('+string(ae)+').target='+string(transA(string_copy(aa,12,4)))+';('+string(ae)+').velocity='+string_copy(aa,16,1)+';('+string(ae)+').reuse=0;',skript,string_length(skript)+1)break;
  case '2': ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_waterregion);skript=string_insert('('+string(ae)+').target='+string(transA(string_copy(aa,12,4)))+';('+string(ae)+').velocity='+string_copy(aa,16,1)+';('+string(ae)+').endx='+string(transA(string_copy(aa,18,4)))+';('+string(ae)+').endy='+string(transA(string_copy(aa,22,4)))+';',skript,string_length(skript)+1)break;
  }
  }
  // ↓原来的
  ...
  if ai=34{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_region);skript=string_insert('('+string(ae)+').endx='+string(transA(string_copy(aa,12,4)))+';'+'('+string(ae)+').endy='+string(transA(string_copy(aa,16,4)))+';',skript,string_length(skript)+1)}
}
 if string_char_at(aa,0)='3'{
  ai=real(string_copy(aa,2,2))
  if ai>0 && ai<7{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_pointblock);skript=string_insert('('+string(ae)+').bonus='+string(ai)+';',skript,string_length(skript)+1)}
  if ai>6 && ai<13{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_pointblock2);skript=string_insert('('+string(ae)+').bonus='+string(ai-6)+';',skript,string_length(skript)+1)}
    if ai>18 && ai<25{ae=room_instance_add(Play_Room2,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_pointblock);skript=string_insert('('+string(ae)+').bonus='+string(ai+82)+';',skript,string_length(skript)+1)}
  switch(ai){
 ...
 if real(string_copy(aa,18,1))!=1{
  ae=room_instance_add(Play_Room2,transA(string_copy(aa,2,4)),transA(string_copy(aa,6,4)),o_exiter)}else
  {ae=room_instance_add(Play_Room2,transA(string_copy(aa,2,4)),transA(string_copy(aa,6,4))-32,o_exiter)}
...
room_set_code(Play_Room2,skript)
skript=''
