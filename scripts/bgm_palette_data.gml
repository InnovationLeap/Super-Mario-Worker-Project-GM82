...
// ==============================================================
// Page 0: Original Mario Worker（左列 22 项 + 右列 7 项，等距网格 行距18 首行y=77，与后页一致）
// ==============================================================
bgm_entry(0, 10, 77, 200, 12, 1, 'SMW Overworld')
bgm_entry(0, 215, 77, 200, 12, 22, 'SMW Castle')
bgm_entry(0, 10, 95, 200, 12, 2, 'Cave')
bgm_entry(0, 215, 95, 200, 12, 20, 'Apoplexy-Tanks')
bgm_entry(0, 10, 113, 200, 12, 3, 'Rockland')
bgm_entry(0, 215, 113, 200, 12, 26, 'Big Bowser')
bgm_entry(0, 10, 131, 200, 12, 4, 'YI Castle')
bgm_entry(0, 215, 131, 200, 12, 25, 'Federation (Map 8)')
bgm_entry(0, 10, 149, 200, 12, 5, 'Riot (Map 1)')
bgm_entry(0, 215, 149, 200, 12, 28, 'Game Select')
bgm_entry(0, 10, 167, 200, 12, 27, 'SMB2U Overworld')
bgm_entry(0, 215, 167, 200, 12, 21, 'Select Save')
bgm_entry(0, 10, 185, 200, 12, 13, 'SMB1 Underwater')
bgm_entry(0, 215, 185, 200, 12, 29, 'Rockland Yoshi')
bgm_entry(0, 10, 203, 200, 12, 6, 'Ghost House')
bgm_entry(0, 10, 221, 200, 12, 7, 'Holiday Anthem (Map 2)')
bgm_entry(0, 10, 239, 200, 12, 8, 'Starland')
bgm_entry(0, 10, 257, 200, 12, 9, 'Starland Platforms')
bgm_entry(0, 10, 275, 200, 12, 10, 'Underground')
bgm_entry(0, 10, 293, 200, 12, 11, 'One Fine Day (Map 3)')
bgm_entry(0, 10, 311, 200, 12, 12, 'YI Theme 4')
bgm_entry(0, 10, 329, 200, 12, 23, 'Trancoi (Map4)')
bgm_entry(0, 10, 347, 200, 12, 14, 'Interference Ending')
bgm_entry(0, 10, 365, 200, 12, 15, 'Sirens')
bgm_entry(0, 10, 383, 200, 12, 16, 'In the Kitchen (Map 5)')
bgm_entry(0, 10, 401, 200, 12, 17, 'YKY')
bgm_entry(0, 10, 419, 200, 12, 18, 'Yet Bonus (Map 6)')
bgm_entry(0, 10, 437, 200, 12, 19, 'YI Overworld')
bgm_entry(0, 10, 455, 200, 12, 24, 'The Golden Ages (Map 7)')

// ==============================================================
// Page 1: Mario Forever Remake（左列 22 项 + 右列 15 项，等距网格 行距18 首行y=77，与后页一致）
// ==============================================================
bgm_entry(1, 10, 77, 200, 12, 41, 'Hiscore (MFAE Title)')
bgm_entry(1, 215, 77, 200, 12, 62, 'Airship Fortress')
bgm_entry(1, 10, 95, 200, 12, 42, 'MK64 Frappe Snowland')
bgm_entry(1, 215, 95, 200, 12, 63, 'Airship Boss Room')
bgm_entry(1, 10, 113, 200, 12, 43, 'NSMB Overworld')
bgm_entry(1, 215, 113, 200, 12, 64, 'Green Star')
bgm_entry(1, 10, 131, 200, 12, 44, 'Rainbow Desort')
bgm_entry(1, 215, 131, 200, 12, 65, 'Kao the Kangaroo (Map U)')
bgm_entry(1, 10, 149, 200, 12, 45, 'MK64 Farm')
bgm_entry(1, 215, 149, 200, 12, 66, 'SMB2U Underground')
bgm_entry(1, 10, 167, 200, 12, 46, 'SSBB Waluigi')
bgm_entry(1, 215, 167, 200, 12, 67, 'SMW VanillaDome')
bgm_entry(1, 10, 185, 200, 12, 47, 'SMB3 Fortress')
bgm_entry(1, 215, 185, 200, 12, 68, 'Dire Dire Docks')
bgm_entry(1, 10, 203, 200, 12, 48, 'DYNA-K (Map 9)')
bgm_entry(1, 215, 203, 200, 12, 69, 'Zelda 2 Palace')
bgm_entry(1, 10, 221, 200, 12, 49, 'LAVA!')
bgm_entry(1, 215, 221, 200, 12, 70, "Bowser's Road")
bgm_entry(1, 10, 239, 200, 12, 50, 'Justice and Freedom')
bgm_entry(1, 215, 239, 200, 12, 71, 'SM Brinstar')
bgm_entry(1, 10, 257, 200, 12, 51, 'Technique (Map 10)')
bgm_entry(1, 215, 257, 200, 12, 73, 'Underwater Yoshi')
bgm_entry(1, 10, 275, 200, 12, 52, 'Cold Cold Mountain')
bgm_entry(1, 215, 275, 200, 12, 74, 'Mario 3 Water')
bgm_entry(1, 10, 293, 200, 12, 53, 'SSBB Underground')
bgm_entry(1, 215, 293, 200, 12, 75, 'Music Hardcore 1-4')
bgm_entry(1, 10, 311, 200, 12, 58, 'Spiller (Map 12)')
bgm_entry(1, 215, 311, 200, 12, 72, 'Syndrome Land')
bgm_entry(1, 10, 329, 200, 12, 54, 'Running the Desert')
bgm_entry(1, 215, 329, 200, 12, 78, 'Dream off')
bgm_entry(1, 10, 347, 200, 12, 55, 'Sunset Desert')
bgm_entry(1, 10, 365, 200, 12, 56, 'LoZ-ST Underwater')
bgm_entry(1, 10, 383, 200, 12, 57, "Alpaca's Adventure Tense")
bgm_entry(1, 10, 401, 200, 12, 76, 'Haunty Halls Galaxy')
bgm_entry(1, 10, 419, 200, 12, 59, 'The Wind Waker (Map 13)')
bgm_entry(1, 10, 437, 200, 12, 60, 'Chain Link Charge')
bgm_entry(1, 10, 455, 200, 12, 61, 'Dragon Roost Island')
