...
o_readsmwpfile.toloadpointer+=1
//show_message(string(o_readsmwpfile.toloadpointer)+":"+o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
global.etapnazw=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
o_readsmwpfile.toloadpointer+=1
global.etapautor=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
o_readsmwpfile.toloadpointer+=1
global.etapczas=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
o_readsmwpfile.toloadpointer+=1
global.etapgravity=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
o_readsmwpfile.toloadpointer+=1
global.etapkuppa=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
global.etapkuppafixed=global.etapkuppa
o_readsmwpfile.toloadpointer+=1
global.poziomwody=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
