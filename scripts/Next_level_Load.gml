...
//global.toload=global.scenariofile
...
tmp3=0;
//show_message(string(o_readsmwpfile.toloadpointer)+":"+o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
room_set_width(Play_Room,real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]))
o_readsmwpfile.toloadpointer+=1
//show_message(string(o_readsmwpfile.toloadpointer)+":"+o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
room_set_height(Play_Room,real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]))
o_readsmwpfile.toloadpointer+=1
//show_message(string(o_readsmwpfile.toloadpointer)+":"+o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
global.level_name_play=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
o_readsmwpfile.toloadpointer+=1
global.level_author=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
o_readsmwpfile.toloadpointer+=1
global.level_time=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
o_readsmwpfile.toloadpointer+=1
global.level_gravity=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
o_readsmwpfile.toloadpointer+=1
global.level_bowser_hp=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
global.bowser_hp_fixed=global.level_bowser_hp
o_readsmwpfile.toloadpointer+=1
global.water_level=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
global.water_height_record=global.water_level
o_readsmwpfile.toloadpointer+=1
global.background=real(o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer])
global.background_record = global.background
o_readsmwpfile.toloadpointer+=1
muzykaa=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
global.music_record = muzykaa
o_readsmwpfile.toloadpointer+=1
var aa,ab,ac,ad,af,ag,ah,ai,aj,zxy;
zxy=room_instance_add(Play_Room,0,0,o_preview)
ah=0
draw_set_alpha(1)
draw_set_color(c_white)
draw_set_blend_mode(bm_normal)
if o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]='BlocksDataStart' {
    o_readsmwpfile.toloadpointer+=1
    aa=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
    ad=0
    while aa!='BlocksEnd' {
...
while o_readsmwpfile.toloadpointer!=o_readsmwpfile.toloadend && aa!='New Level' {
    o_readsmwpfile.toloadpointer+=1
    aa=o_readsmwpfile.toloadtext[o_readsmwpfile.toloadpointer]
    ...
    if string_char_at(aa,1)='2' {
        ...
        if ai=20 {ae=room_instance_add(Play_Room,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_checkpoint);skript=string_insert('('+string(ae)+').checknumber='+string(checka)+';',skript,string_length(skript)+1);if global.loadingsav=0 {global.check[checka,0]=0;global.check[checka,1]=0;}checka+=1}
    ...
    if string_char_at(aa,1)='3' {
        ...
        case(15):ae=room_instance_add(Play_Room,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_blockbumper);skript=string_insert('('+string(ae)+').block=1;('+string(ae)+').bump_count=16;('+string(ae)+').bumped=1',skript,string_length(skript)+1);break;
        case(16):ae=room_instance_add(Play_Room,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_blockbumper);break;
        ...
        case(25):ae=room_instance_add(Play_Room,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_pointblock);skript=string_insert('('+string(ae)+').bonus=7;',skript,string_length(skript)+1);break;
        case(26):ae=room_instance_add(Play_Room,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_pointblock2);skript=string_insert('('+string(ae)+').bonus=8;',skript,string_length(skript)+1);break;
        case(27):ae=room_instance_add(Play_Room,transA(string_copy(aa,4,4)),transA(string_copy(aa,8,4)),o_pointblock);skript=string_insert('('+string(ae)+').bonus=107;',skript,string_length(skript)+1);break;
        }
...
if o_readsmwpfile.toloadpointer=o_readsmwpfile.toloadend {global.lastlev=1}
