...
// 滚轮类（7/14/15/19-24）只写文字、不画图标，由现有覆盖层提供预览。
// TYPE A(11)/TYPE B(12) 改为用游戏内 s_yinyang 贴图绘制，滚轮改色由 global.yinyangcolor 驱动。
...
_label = argument3
_wheel = 0
if _pc4 = 7 || _pc4 = 14 || _pc4 = 15 || (_pc4 >= 19 && _pc4 <= 24) {_wheel = 1}
if _wheel = 0 {
    _spr = -1
    _sub = 0
    _sw = 32
    ...
    switch (_pc4) {
        ...
        // SCENE CONTROL
        case 16: {_spr = s_bgmchange; _sub = 0;} break;
        // VIEW CONTROL
