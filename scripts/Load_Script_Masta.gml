...
*/
    ...
    if string_char_at(aa,1)='4' {
        if real(string_copy(aa,18,1))!=1 {
            ae=instance_create(transA(string_copy(aa,2,4)),transA(string_copy(aa,6,4)),o_edpassage)} else {ae=instance_create(transA(string_copy(aa,2,4)),transA(string_copy(aa,6,4))-32,o_edpassage)}
