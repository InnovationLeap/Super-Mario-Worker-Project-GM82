...
global.key_up=ini_read_real('KeyConfig','up',vk_up)
global.key_down=ini_read_real('KeyConfig','down',vk_down)
global.key_left=ini_read_real('KeyConfig','left',vk_left)
global.key_right=ini_read_real('KeyConfig','right',vk_right)
global.key_jump=ini_read_real('KeyConfig','jump',ord('Z'))
global.key_fire=ini_read_real('KeyConfig','fire',ord('X'))
global.key_restart=ini_read_real('KeyConfig','restartlevel',ord('Q'))
